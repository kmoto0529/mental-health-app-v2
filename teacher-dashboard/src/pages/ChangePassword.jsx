  ...
  return (
    <div style={styles.wrap}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>セキュリティのため、初回ログイン時に<br />パスワードを変更してください</p>
...
const styles = {
  ...
  sub: { fontSize: '13px', color: '#8a96aa', textAlign: 'center', marginBottom: '32px', lineHeight: '1.6' },
  form: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { fontSize: '13px', fontWeight: '700', color: '#4a5568', marginTop: '10px' },
  input: { padding: '12px 14px', border: '2px solid #e8ecf4', borderRadius: '12px', fontSize: '15px', outline: 'none' },
