...
このフォルダには Aside のマスコット「まめこ」の画像アセットを配置します。
...
```
growth/
  stage1-tane.png         たねのまめこ（出会ったばかり）
  stage2-futaba.png       ふたばのまめこ（標準形）
  stage3-nae.png          なえのまめこ（ぐんぐん成長）
  stage4-hana.png         はなのまめこ（花が咲いた）
  stage5-ookii.png        おおきなまめこ（鉢植え）
